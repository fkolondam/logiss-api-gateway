  ...
  "netlify/functions/utils/gas.js"(exports2, module2) {
    ...
    async function fetchGas2(action, data = null) {
      try {
        ...
        if (options.body) {
          ...
          console.log("Request Body:", {
            ...
            data: parsedBody.data ? {
              ...parsedBody.data,
              hashedPassword: parsedBody.data.hashedPassword ? "[REDACTED]" : void 0
            } : void 0
          });
        }
        ...
        console.log(
          "Raw Response:",
          responseText.length > 1e3 ? `${responseText.substring(0, 1e3)}... [truncated]` : responseText
        );
...
var require_auth = __commonJS({
  "netlify/functions/utils/auth.js"(exports2, module2) {
    ...
    function generateToken2(payload) {
      try {
    ...
    function getTokenFromRequest2(event) {
      try {
        console.log("Request headers:", {
          ...event.headers,
          authorization: event.headers.authorization ? event.headers.authorization.substring(0, 20) + "..." : void 0,
  ...
  "netlify/functions/utils/response.js"(exports2, module2) {
    function createResponse2(statusCode, data, options = {}) {
      ...
      const successResponse = {
        success: true,
        ...typeof data === "object" && data !== null ? data.data ? data : { data } : { data }
      };
      return {
        statusCode,
        headers,
...
exports.handler = async (event) => {
  ...
  try {
    ...
    console.log("Headers:", {
      ...event.headers,
      authorization: event.headers.authorization ? "[REDACTED]" : void 0
    });
    ...
    console.log("Request Body:", body ? {
      ...
      data: body.data ? {
        ...body.data,
        hashedPassword: body.data.hashedPassword ? "[REDACTED]" : void 0
      } : void 0
    } : null);
