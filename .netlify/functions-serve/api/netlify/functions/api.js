...
var PROTECTED_ROUTES = ["checkin", "checkout", "delivery"];
exports.handler = async (event) => {
  ...
  try {
    ...
    if (!gasResponse.success) {
      const statusCode = gasResponse.error?.includes("tidak ditemukan") ? 404 : gasResponse.error?.includes("tidak lengkap") ? 400 : 500;
      return createResponse(statusCode, gasResponse, { origin: origin2 });
    }
